# [Platinum III] PriorityQueue가 아니에요 - 35155 

[문제 링크](https://www.acmicpc.net/problem/35155) 

### 성능 요약

메모리: 30668 KB, 시간: 564 ms
...
2026년 1월 20일 11:55:37

### 문제 설명

<p>지훈이는 <strong>PQ</strong>라는 자료구조를 만들었다. 하지만 <strong>PQ</strong>라는 이름의 특성상 PriorityQueue으로 오해받고는 한다.</p>

<p><strong>PQ</strong> 자료구조는 문자 <code>P</code>를 저장하는 큐(Queue)로, 다음 두 명령어를 사용한다.</p>

<ul>
<li><code>PP</code>: 문자 <code>P</code> 하나를 <strong>PQ</strong> 큐 맨 앞에 Push한다.</li>
<li><code>P</code>: <strong>PQ</strong> 큐 맨 뒤의 문자 <code>P</code> 하나를 pop한다. 단, <strong>PQ</strong> 큐가 비어 있을 때는 수행할 수 없다.</li>
</ul>
...
<p>처음에 <strong>PQ</strong> 큐가 비어 있을 때, <mjx-container class="MathJax" jax="CHTML" style="font-size: 109%; position: relative;"><mjx-math class="MJX-TEX" aria-hidden="true"><mjx-mi class="mjx-i"><mjx-c class="mjx-c1D441 TEX-I"></mjx-c></mjx-mi></mjx-math><mjx-assistive-mml unselectable="on" display="inline"><math xmlns="http://www.w3.org/1998/Math/MathML"><mi>N</mi></math></mjx-assistive-mml><span aria-hidden="true" class="no-mathjax mjx-copytext">$N$</span></mjx-container>개의 <code>P</code>로 이루어진 문자열을 유효하게 해석할 수 있는 경우의 수를 구해보자. 비어 있는 <strong>PQ</strong> 큐에서 pop을 하는 경우 유효하지 않은 해석임을 유의하자.</p>
